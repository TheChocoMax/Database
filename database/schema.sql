...
CREATE TYPE user_2fa_method AS ENUM ('TOTP', 'WebAuthn');
...
CREATE TABLE user_2fas (
    user_2fa_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id INTEGER NOT NULL REFERENCES users (id) ON DELETE CASCADE,
    user_2fa_secret TEXT NOT NULL, -- Base32 encoded secret for TOTP
    is_enabled BOOLEAN DEFAULT FALSE,
    2fa_method user_2fa_method NOT NULL,
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE admin_accounts (
    ...
    user_id INTEGER NOT NULL REFERENCES users (id) ON DELETE CASCADE,
    adminadmin_account_role admin_account_role NOT NULL,
    is_active BOOLEAN DEFAULT TRUE,
